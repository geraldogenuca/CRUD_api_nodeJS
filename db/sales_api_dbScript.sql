...
CREATE TABLE IF NOT EXISTS `sales_api`.`costumers` (
  ...
  `email_costumer` VARCHAR(80) NULL DEFAULT NULL,
  `password_costumer` VARCHAR(200) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`location` (
  ...
  `name_city` VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`address` (
  ...
  `name_street` VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`products` (
  ...
  `name_product` VARCHAR(150) NULL DEFAULT NULL,
  `price_product` DECIMAL(7,2) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`categories` (
  ...
  `name_category` VARCHAR(80) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`images_products` (
  ...
  `path_image` VARCHAR(500) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`orders` (
  ...
  `id_costumer` INT(11) NULL DEFAULT NULL,
  `id_product` INT(11) NULL DEFAULT NULL,
  `quantity_product` SMALLINT(6) NULL DEFAULT NULL,
  `updated_at` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `sales_api`.`employees` (
  ...
  `name_employee` VARCHAR(150) NULL DEFAULT NULL,
  `email_employee` VARCHAR(80) NULL DEFAULT 'mail@mail',
  `cpf_employee` VARCHAR(11) NULL DEFAULT NULL,
  `password_employee` VARCHAR(200) NULL DEFAULT NULL,
